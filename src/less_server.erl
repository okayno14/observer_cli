...
handle_call({page}, _From, State) ->
    {reply, page_(State), State};
handle_call({next}, _From, State) ->
    State2 = next_(State),
    {reply, page_(State2), State2};
...
%%--------------------------------------------------------------------
state(String) ->
    state_(string_to_buf(String), os:getenv("LINES", 43)).
%%--------------------------------------------------------------------
...
%%--------------------------------------------------------------------
state(String, Lines) ->
    state_(string_to_buf(String), Lines).
%%--------------------------------------------------------------------

%%--------------------------------------------------------------------
%% @doc
-spec state_(Buf :: list(string()), Lines :: pos_integer()) ->
    state().
%%--------------------------------------------------------------------
state_(Buf, Lines) ->
